# -*- coding: utf-8 -*-
#
# diarc documentation build configuration file, created by
...
latex_documents = [
  ('index', 'diarc.tex', u'diarc Documentation',
   u'Dan Brooks', 'manual'),
]
...
man_pages = [
    ('index', 'diarc', u'diarc Documentation',
     [u'Dan Brooks'], 1)
]
...
texinfo_documents = [
  ('index', 'diarc', u'diarc Documentation',
   u'Dan Brooks', 'diarc', 'One line description of project.',
   'Miscellaneous'),
]
